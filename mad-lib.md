...
## Begin by asking for the types of words you need
Use the ``||game:ask for string||`` code. You will ask for a place, verb, feeling and another verb.

```python
  game.ask_for_string("Enter a place: ")
  game.ask_for_string("Enter a place: ")
  game.ask_for_string("Enter a place: ")
  game.ask_for_string("Enter a place: ")
```
